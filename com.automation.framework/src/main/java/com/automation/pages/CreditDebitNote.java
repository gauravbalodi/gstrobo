...
public class CreditDebitNote {
	...
	@FindBy(xpath = "//li[@ng-repeat='Child1 in GetChild(Child.FormId)'][2]")
	WebElement creditDebitNoteMenu;

	@FindBy(xpath = "//h1[contains(text(),'Credit/Debit Notes')]")
	WebElement creditDebitNoteText;
	...
	WebElement debitRadioButton;

	@FindBy(xpath = "//input[@id='txtInvoiceDate']")
	...
	@FindBy(xpath = "//span[contains(text(),'Credit/Debit note type required')]")
	WebElement cdnReqMsg;
	...
	@FindBy(xpath="//body[1]/div[1]/div[1]/div[2]/div[1]/section[2]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[6]/div[5]/div[1]/div[1]/label[1]")
	WebElement diffInTaxRateOnly;
	
	@FindBy(xpath="//input[@id='ReasonForissuing']")
	WebElement reasonForNote;

	@FindBy(xpath="//input[@id='InvoiceNo']")
    WebElement originalInvoiceNo;
	
	@FindBy(xpath="//select[@id='DrInvoicrTypeId']")
	WebElement invoiceType;
	
	
	
    public void clickOnCdnMenu() {
	...
	public void clickOnCreditRadioButton() {
		creditRadioButton.click();
	}

	public void clickOnDebitRadioButton() {
	...
	public void enterMultipleLineItems() throws Exception {
		...
		for (row = 1; row <= length; row++) {
			Thread.sleep(500);
			WebDriver driver = getDriver();
			WebElement itemProductName = driver
					.findElement(By.xpath("//tbody/tr[" + row + "]/td[1]/div[1]/div[1]/select[1]"));
			WebElement addButton = driver
					.findElement(By.xpath("//tbody/tr[" + row + "]/td[11]/button[@data-original-title='Add']"));
			WebElement qty = driver.findElement(By.xpath("//tbody/tr[" + row + "]/td[5]//input"));
			WebElement tax = driver
					.findElement(By.xpath("//tbody/tr[" + row + "]/td[6]/ng-form/div[1]/div[1]/select[1]"));
	...
	public void checkRequiredFeilds() {
		...
		Assert.assertTrue(cdnReqMsg.isDisplayed());
	...
	public void ClickOnDiffInTaxRateOnly() {
		diffInTaxRateOnly.click();
	}
	
	public void SendReasonForNote(String reason) {
		reasonForNote.sendKeys(reason);
	}
	
	public void SendOriginalInvoiceNo(String invoiceNo) {
		originalInvoiceNo.sendKeys(invoiceNo);
	}
	
	public void selectInvoiceType(String type) {
		Select invType=new Select(invoiceType);
